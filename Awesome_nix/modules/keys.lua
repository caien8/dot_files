...
globalkeys = gears.table.join(
    -- TERMINAL
    awful.key({ mod,}, "Return", function () awful.spawn(terminal) end, {description = "open a terminal", group = "Apps"}),
    -- RESTART & QUIT
    ...
    -- SHORTCUT
    awful.key({ mod,}, "s",      hotkeys_popup.show_help, {description="shortcuts", group="awesome"}),

    -- MENU
    awful.key({ mod,}, ";", function () mymainmenu:show() end, {description = "show main menu", group = "awesome"}),

    -- Prompt
    --//awful.key({ mod }, "p",     function () awful.screen.focused().mypromptbox:run() end, {description = "run prompt", group = "launcher"}),

    -- DMENU
    awful.key({mod}, "d", function() awful.util.spawn("dmenu_run") end, {description = "run dmenu", group = "launcher"}),

    -- BRAVE
    awful.key({mod}, "w", function() awful.util.spawn("brave") end, {description = "run Brave", group = "Apps"}),
    
    --* CODIUM
    awful.key({mod}, "v", function() awful.util.spawn("codium") end, {description = "run Codium", group = "Apps"}),
    
    --* THUNAR
    awful.key({mod}, "f", function() awful.util.spawn("thunar") end, {description = "run Thunar", group = "Apps"}),
    ...
    -- Menubar
    awful.key({ mod }, "a", function() menubar.show() end,
